...
# ------------------------------------
def save_global_results_to_csv(all_results, filename="regression_results.csv"):
    """
    ...
    results_dir = os.path.join(project_root, "results3")
    ...
    for name, col in metrics.items():
        ...
        file_name = f"regression_{name}.csv"
